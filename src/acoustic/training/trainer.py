...
class Trainer:
    """
    Universal trainer wrapper around Seq2SeqTrainer.
    Accepts a data collator (can be model-specific) or creates a default one.
    """
    ...
    def _setup_trainer(self) -> None:
        # Use provided data collator or create a default one
